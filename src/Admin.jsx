                ...
                {supSel ? (() => {
                  ...
                  {annonceOpen && (
                    <div style={{ background: "#1a1a1a", border: "1px solid #c9a84c55", borderRadius: 10, padding: 14, marginBottom: 14 }}>
                      ...
                      <textarea value={annonceTxt} onChange={e => setAnnonceTxt(e.target.value)} placeholder="Ton message à tous les auteurs… (les sauts de ligne sont conservés)" rows={8} style={{ width: "100%", padding: "10px 12px", background: "#0f0f0f", border: "1px solid #333", borderRadius: 8, color: "#fff", fontSize: 14, resize: "vertical", fontFamily: "inherit", boxSizing: "border-box", marginBottom: 8, lineHeight: 1.5, whiteSpace: "pre-wrap" }} />
