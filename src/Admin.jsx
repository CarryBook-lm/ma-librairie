                ...
                {supSel ? (() => {
                  ...
                  {annonceOpen && (
                    <div style={{ background: "#1a1a1a", border: "1px solid #c9a84c55", borderRadius: 10, padding: 14, marginBottom: 14 }}>
                      ...
                      <textarea value={annonceTxt} onChange={e => setAnnonceTxt(e.target.value)} placeholder="Écris ton message à tous les auteurs…&#10;Appuie sur Entrée pour aller à la ligne." rows={10} style={{ width: "100%", minHeight: 220, padding: "12px 14px", background: "#0f0f0f", border: "1px solid #333", borderRadius: 8, color: "#fff", fontSize: 15, resize: "vertical", fontFamily: "inherit", boxSizing: "border-box", marginBottom: 8, lineHeight: 1.55, whiteSpace: "pre-wrap" }} />
